...
5. Finally use the `python.exe` in the folder to execute your script, such the [example scripts](https://github.com/dcnieho/labManager/tree/master/example-scripts/admin-server.py) to launch this tool.
