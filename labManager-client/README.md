...
5. Finally use the `python.exe` in the folder to execute your script, such the [example scripts](https://github.com/dcnieho/labManager/tree/master/example-scripts/client.py) to launch this tool.
