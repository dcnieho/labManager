...
=== Example script
An example script for running the labManager {tool-name} script is link:{repo-home}/example-scripts/[provided here].
...
5. Finally use the `python.exe` in the folder to execute your script, such as one of the link:{repo-home}/example_scripts[example scripts].
