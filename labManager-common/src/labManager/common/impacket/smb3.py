...
from . import nmb, ntlm, uuid, crypto
...
#            pass
        ...
        if mutualAuth == True:
            from .krb5.constants import APOptions
        ...
        if ans.isValidAnswer(STATUS_SUCCESS):
            ...
            if mutualAuth == True:
                ...
                from .krb5.asn1 import AP_REP, EncAPRepPart
                from .krb5.crypto import Key, _enctype_table
