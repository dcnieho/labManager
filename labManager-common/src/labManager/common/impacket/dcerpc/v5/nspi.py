...
from ... import hresult_errors, mapi_constants, uuid
from ...uuid import EMPTY_UUID
from ...structure import Structure
from ...dcerpc.v5.dtypes import NULL, STR, DWORD, LPDWORD, UUID, PUUID, LONG, ULONG, \
    FILETIME, PFILETIME, BYTE, SHORT, LPSTR, LPWSTR, USHORT, LPLONG, DWORD_ARRAY
from ...ldap.ldaptypes import LDAP_SID
from ...dcerpc.v5.ndr import NDR, NDRCALL, NDRPOINTER, NDRSTRUCT, NDRUNION, \
    NDRUniConformantVaryingArray, NDRUniConformantArray, NDRUniVaryingArray
from ...dcerpc.v5.rpcrt import DCERPCException
from ...uuid import string_to_bin, uuidtup_to_bin, EMPTY_UUID
