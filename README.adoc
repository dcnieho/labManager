...
.. A disk image can be redeployed on a later day and work on it continued, or it can be deleted when no longer needed.
...
.. The researcher can then remotely issue a command to the computer stations to run their experiment.
