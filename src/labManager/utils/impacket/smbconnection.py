...
from . import smb, smb3, nmb, nt_errors, LOG
from .ntlm import compute_lmhash, compute_nthash
from .smb3structs import SMB2Packet, SMB2_DIALECT_002, SMB2_DIALECT_21, SMB2_DIALECT_30, GENERIC_ALL, FILE_SHARE_READ, \
...
class SMBConnection:
    ...
    def kerberosLogin(self, user, password, domain='', lmhash='', nthash='', aesKey='', kdcHost=None, TGT=None,
        ...
        from .krb5.kerberosv5 import KerberosError
    ...
    def listShares(self):
        ...
        from .dcerpc.v5 import transport, srvs
