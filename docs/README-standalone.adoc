...
5. Finally use the `python.exe` in the folder to execute your script, such as one of the https://github.com/dcnieho/labManager/tree/master/example_scripts[example scripts].
